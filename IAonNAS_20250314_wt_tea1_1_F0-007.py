...
# -*- coding: utf-8 -*-
"""
Created on Thu Mar 27 10:32:30 2025
...
# Paths
input_ims = "/Volumes/Movies/20250314/20250314_wt tea1_1/20250314_wt tea1_1_F0-007.ims"
output_frames_folder = "/Volumes/Movies/20250314/20250314_wt tea1_1/Frames_F0-007"
output_masks_folder = "/Volumes/Movies/20250314/20250314_wt tea1_1/Masks_F0-007"
...
with tqdm(total=total_tasks, desc="Processing time points") as pbar:
    for t in range(time_points):
        ...
        for c in [0, 1]:
            ...
            projected_filename = f"20250314_wt tea1_1_F0-007_t_{t:02d}_c_{c:01d}.tif"
            ...
            seg_filename = f"20250314_wt tea1_1_F0-007_t_{t:02d}_c_{c:01d}_seg.tif"
        ...
        img_name = f"20250314_wt tea1_1_F0-007_t_{t:02d}_z_{z:01d}_c_{c:01d}.tif"
        ...
        masks, flows, styles, *extra = model.eval(selected_img,
                                                  channels=channels_for_segmentation,
                                                  diameter=diameter)
        seg_filename = f"20250314_wt tea1_1_F0-007_t_{t:02d}_z_{z:01d}_c_{c:01d}_seg.tif"
...
output_tracked_cells_folder = "/Volumes/Movies/20250314/20250314_wt tea1_1/TrackedCells_F0-007"
...
for cell in filtered_regions:
    ...
    for t, bf_mask_path in enumerate(mask_paths):
        ...
        c = 0 
        fluorescent_GFP_frame_path = os.path.join(output_frames_folder, f"20250314_wt tea1_1_F0-007_t_{t:02d}_c_{c:01d}.tif")
        c = 1
        fluorescent_RFP_frame_path = os.path.join(output_frames_folder, f"20250314_wt tea1_1_F0-007_t_{t:02d}_c_{c:01d}.tif")
        c = 2
        z = 4
        brightfield_frame_path = os.path.join(output_frames_folder, f"20250314_wt tea1_1_F0-007_t_{t:02d}_z_{z:01d}_c_{c:01d}.tif")
