#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Feature extraction for M162 model-based dense tracking (stage 5).
...
M162 is compared directly against M161 (its session replicate) and
M160, so this is held identical to build_features_m161.py apart from
paths and sequence names.
