...
# -*- coding: utf-8 -*-
"""
Created on Mon May  5 10:02:59 2025
...
# Paths
working_dir = "/Volumes/Movies/2025_04_30_M57/"
file_name = "WT_cdc10_G1_1_F0"
input_ims = f"{working_dir}{file_name}.ims"
output_frames_folder = f"{working_dir}Frames_{file_name}"
output_masks_folder = f"{working_dir}Masks_{file_name}"
...
out_dir = f"{working_dir}TrackedCells_{file_name}"
...
output_tracked_cells_folder = f"{working_dir}TrackedCells_{file_name}"
...
for cell in filtered_regions:
    ...
    for t, bf_mask_path in enumerate(mask_paths):
        ...
        C1min, C1max = 98, 125  # Adjust based on your data
