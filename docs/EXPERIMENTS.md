...
| M160 | 2026-08-28 | `2026_08_28_M160` | `5_1_N1`, `FL1`–`FL7` + `BF1`–`BF6` | bf+gfp | 13-film `5_1_N1_{F}` (excl. `N1_2`, `snap`) | `retrack_m160_sequences.py`, `retrack_3frames_m160.py`, `submit_array_M160.sh`; ABBT [report 2026-09-08](development_reports/development_report_2026_09_08.md); dense tracking [report 2026-09-11](development_reports/development_report_2026_09_11.md); model-based dense tracking [report 2026-09-11](development_reports/development_report_2026_09_11_model_based_dense_tracking.md); stages 5-6 complete (features, lineage, division, cell cycle, 6D AE, explorer); **manifold is continuous, no discrete modes, and the cells are growth-arrested** (BF doubling 57.7 h vs M162's 3.93 h; medium is EMM, M161/M162 are YES — same strain and probe) - see [experiment report 2026-09-21](development_reports/development_report_2026_09_21_m160_continuous_manifold.md) | |
| M161 | 2026-09-03 | `2026_09_03_M161` (raw on NAS `/Volumes/Movies/2026_09_03_M161`; FL1+BF1 copied to SSD `/Volumes/X10 Pro/Movies/2026_09_03_M161`) | `NeonG_YES_1`, `FL1`–`FL6` + `BF1`–`BF5` | bf+gfp | 11-film `NeonG_YES_1_{film}_{F}` (4 fields `F0`–`F3`) | FL1 through stages 1–5 on 2026-09-22 (363 cells, 0.49% model-only); rest of the experiment still raw; 7.8 GB, 60 `.ims`. **BF cannot give a growth rate**: its BF protocol is 10 frames × 30 s = 5 min vs M160/M162's 41 × 30 s = 20.5 min, and its BF keyframes are not [0,20,40]. Same condition and acquisition settings as M162 (101×12 s, 350/120 ms, laser 2 @ 5), different session — so it is the **replicate control** for the M160 comparison, see [experiment report 2026-09-21](development_reports/development_report_2026_09_21_m160_continuous_manifold.md) | FL1 through stages 1–5 on 2026-09-22 (363 cells); [dev report 2026-09-22](development_reports/development_report_2026_09_22_m161_m162_pipeline_and_growth.md) |
| M162 | 2026-09-09 | `2026_09_09_M162` | `NeonG_YES`, `FL1`–`FL4` + `BF1`–`BF3` | bf+gfp | 7-film `NeonG_YES_{film}_{F}` (4 fields `F0`–`F3`) | newest; `segment_m162_keyframes.py`, `track_and_link_m162.py`, `apply_abbt_m162.py`; stages 3–5 complete for FL1 on 2026-09-22 (758 cells, 0.21% model-only), stage 6 pending; BF `TrackedCells` are **keyframe-only** (3 of 41 frames carry an RLE) so per-frame BF area must come from the stage-3 dense masks; illumination-matched control for M160 (same laser line, intensity 5, 101x12s; exposure 350/120 vs 400/100 ms); [dev report 2026-09-22](development_reports/development_report_2026_09_22_m161_m162_pipeline_and_growth.md) | |
...
- **The NAS holds experiments this ledger does not.** As of 2026-09-21
  `/Volumes/Movies` also contains M157, M158, M159, M163, M164, M165, M166 and
  M167, none of them recorded here. Some may be better-matched controls than
  M162. Search the NAS mount, not just the SSD, before concluding an experiment
  does not exist.
