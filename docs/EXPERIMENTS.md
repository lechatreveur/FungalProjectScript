...
| M161 | 2026-09-03 | `2026_09_03_M161` (**NAS only**: `/Volumes/Movies/2026_09_03_M161`) | `NeonG_YES_1`, `FL1`–`FL6` + `BF1`–`BF5` | bf+gfp | 11-film `NeonG_YES_1_{film}_{F}` (4 fields `F0`–`F3`) | **raw only — no segmentation, tracking or quantification**; 7.8 GB, 60 `.ims`. Same condition and acquisition settings as M162 (101×12 s, 350/120 ms, laser 2 @ 5), different session — so it is the **replicate control** for the M160 comparison, see [experiment report 2026-09-21](development_reports/2026-09-21_M160_continuous_distribution_experiment_report.md) | |
