...
OUTPUT_HTML = "/Volumes/X10 Pro/FungalProject_Outputs/fc_contrastive/fc_manifold_explorer.html"
...
def main():
    ...
    fig = px.scatter_3d(df, x="x", y="y", z="z",
        ...
        title="Fungal Multimodal Manifold Explorer (3D)",
...
<head>
  <meta charset="utf-8"/>
  <title>Fungal Manifold Explorer 3D</title>
  <style>
