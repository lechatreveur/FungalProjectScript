...
OUTPUT_HTML = "/Volumes/X10 Pro/FungalProject_Outputs/fc_ae_3d/fc_ae_3d_manifold_explorer.html"
...
def main():
    ...
    fig_3d = px.scatter_3d(df_3d, x="x", y="y", z="z", color="color", symbol="exp", hover_data=["gid"],
                           title="Fungal Multimodal Manifold Explorer (3D AE)", color_continuous_scale="Viridis")
...
<head>
  <meta charset="utf-8"/>
  <title>Fungal Manifold Explorer 2D/3D (3D AE)</title>
  <style>
