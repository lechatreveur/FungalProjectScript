...
# All per-field film names used by this experiment
_M92_BASE_NAMES = [
    "A14-YES-1t-FBFBF",
    "A14-YES-1t-FBFBF-2",
    "A14-YES-1t-FBFBF-3",
...
ALL_FILM_NAMES = [f"{base}_{field}" for base in _M92_BASE_NAMES for field in FIELDS]
...
# -------------------------------------------------
# Use the current shared helper from visualization.py (same API as M93)
from SingleCellDataAnalysis.visualization import load_good_gfp1_gfp2_for_field, plot_aligned_signals, plot_aligned_heatmaps

# M92 film name list (ordered: GFP1, BF1, GFP2, BF2, GFP3)
FILM_NAMES_M92 = [
    "A14-YES-1t-FBFBF",
    "A14-YES-1t-FBFBF-2",
    "A14-YES-1t-FBFBF-3",
...
for field in FIELDS:
    d1, d2 = load_good_gfp1_gfp2_for_field(
        field, FILM_NAMES_M92, WORKING_DIR, all_global_maps, all_res,
